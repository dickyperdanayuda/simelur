					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select class="form-control select" name="id_penyalurandt" id="id_penyalurandt">
									<option value="">== Pilih Judul ==</option>
										<?php foreach ($penyaluran as $pyl) {
										?>
											<option value="<?= $pyl->id_penyaluran; ?>"><?= "{$pyl->nama_penyaluran}"; ?></option>
										<?php } ?>
								</select>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label>Gambar Penyaluran</label>
								<input type="file" class="form-control" name="gambar" id="gambar" onchange="previewImage1()" placeholder="Pic" >
							</div>
						</div>
...
<script>
	...
	function drawTable() {
		$('#tabel-pengguna').DataTable({
			...
			"ajax": {
				"url": "ajax_list_detail_penyaluran/",
				"type": "POST"
			},
